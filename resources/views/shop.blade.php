...
@section('content')
                                    ...
                                    @foreach ($categories as $category)
                                        <li class="list-item">
                                            ...
                                            <span class="text-right float-end">
                                                {{ $isAuctionPage ? $category->auction_products_count : $category->regular_products_count }}
                                            </span>
                                        </li>
                                    @endforeach
                                </ul>
                                ...
                                <ul class="list list-inline mb-0 brand-list">
                                    @foreach ($brands as $brand)
                                        <li class="list-item">
                                            ...
                                            <span class="text-right float-end">
                                                {{ $isAuctionPage ? $brand->auction_products_count : $brand->regular_products_count }}
                                            </span>
                                        </li>
                                    @endforeach
                                </ul>
                                ...
                                <div class="pc__info position-relative">
                                        <p class="pc__category">
                                            ...
                                            @if($product->auction_enabled)
                                                <span class="badge bg-warning text-dark ms-2">Lelang</span>
                                            @endif
                                        </p>
    ...
    <form id="frmfilter" method="GET" action="{{ $isAuctionPage ? route('shop.auctions') : route('shop.index') }}">
